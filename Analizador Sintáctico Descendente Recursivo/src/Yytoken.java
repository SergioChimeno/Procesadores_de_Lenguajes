...
public class Yytoken{
	...
	public void errorMatch(String refStrToken) {
		System.out.println("[Parser] Error: "+ refStrToken+" expected, "+m_tktype+" found (line: "+m_line+", column: "+m_column+")");
	}
	
	// Error message without saying anything about the expected token
	public void error(String msg) {
		System.out.println("[Parser] Error: "+msg+":"+m_tktype+"found (line: "+m_line+", column: "+m_column+")");
	}
}
